...
contract FunctionReferenceLibTest is Test {
    ...
    function testFuzz_functionReference_packing(address addr, uint8 functionId) public pure {
    ...
    function testFuzz_functionReference_operators(FunctionReference a, FunctionReference b) public pure {
        assertTrue(a.eq(a));
        assertTrue(b.eq(b));
